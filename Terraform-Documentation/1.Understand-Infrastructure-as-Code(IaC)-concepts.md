...
* **Azure ARM templates** - AZURE native tool
* **Pulumi** – IAC using general-purpose languages (e.g., TypeScript, Python)
* **Ansible** – Configuration management and provisioning
* **Chef/Puppet/SaltStack** – Older but still used configuration tools

## Benefits of Infrastructure as Code (IaC):

* **Speed & Efficiency:** Quickly spin up infrastructure via scripts
* **Consistency:** Avoid "drift" or mismatched environments
* **Collaboration:** Treat infrastructure like application code
* **Testing & Validation:** Run tests and lint checks on infrastructure code
* **Auditability:** Track changes through version history
